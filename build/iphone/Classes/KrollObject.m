...
//@interface TiGrouponObject : NSObject
//@end

@interface TiGrouponObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiGrouponObject class]])
		{
			for (NSString *key in [[(TiGrouponObject*)o modules] allKeys])
			{
