...
// in simulator we redefine to format for TiGroupon Developer console
...
{\
	NSString * exceptionName = [@"org.tigroupon." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tigroupon";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITiGrouponNativeItemNone = -1, 
	UITiGrouponNativeItemSpinner = -2,
	UITiGrouponNativeItemProgressBar = -3,
	
	UITiGrouponNativeItemSlider = -4,
	UITiGrouponNativeItemSwitch = -5,
	UITiGrouponNativeItemMultiButton = -6,
	UITiGrouponNativeItemSegmented = -7,
	
	UITiGrouponNativeItemTextView = -8,
	UITiGrouponNativeItemTextField = -9,
	UITiGrouponNativeItemSearchBar = -10,
	
	UITiGrouponNativeItemPicker = -11,
	UITiGrouponNativeItemDatePicker = -12,
	
	UITiGrouponNativeItemInfoLight = -13,
	UITiGrouponNativeItemInfoDark = -14,
	
	UITiGrouponNativeItemDisclosure = -15,
	
	UITiGrouponNativeItemContactAdd = -16
};
